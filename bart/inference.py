    ...
    for step, batch in enumerate(eval_dataloader):
        with torch.no_grad():
            ...
            for i in range(len(decoded_preds)):
                ...
                m2_result = {"id": raw_datasets["validation"][int(args.batch) * step + i]['id'], "instruction": raw_datasets["validation"][int(args.batch) * step + i]['instruction'], "output": [decoded_preds[i]]}
