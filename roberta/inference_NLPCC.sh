...
do
    ...
    CUDA_VISIBLE_DEVICES=${1} python3 inference.py --cuda ${1} --model ./models/model_NLPCC01/epoch_${i} --data ../process_data/NLPCC2018_valid.json --output ./pd_NLPCC/pd_${i}.json
done