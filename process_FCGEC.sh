...
python3 process_FCGEC.py --input ./data/FCGEC_train.json --output ./processed_data/FCGEC_train_all.json --max_data 100000
python3 process_FCGEC.py --input ./data/FCGEC_train.json --output ./processed_data/FCGEC_train_all_tw_llm.json --format tw_llm --max_data 100000
